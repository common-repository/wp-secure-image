...
Donate link: https://artistscope.com/secure_image_protection.asp
...
Insert [Secure Image Pro]( http://artistscope.com/secure_image_protection.asp) encrypted images to pages and posts from your WordPress page editor that are supported across all web browsers on all operating systems, ie: Windows, Mac and Linux. Hand-held devices that can use Java will also be supported.

* Easy install.
* Upload and embed encrypted images using WordPress native media tools.
* Insert [encrypted images](http://artistscope.com/secure_image_protection.asp) into posts or pages using a media button.
...
* [Domain locked images](http://artistscope.com/secure_image_protection.asp) are safe from spiders and even your Webmaster.
...
More information and online demos can be seen at the [Secure Image Protection]( http://artistscope.com/secure_image_protection.asp) website. 

You can see this plugin in action online plus our other WP [copy protection plugins](http://wordpress.artistscope.com) at our WordPress demo site.
...
For more information visit the [Secure Image](http://artistscope.com/secure_image_protection.asp) plugin page at ArtistScope.
...
= 2.0 =
* Revised for compatibility with WP 6.1. 

= 1.16 =
* Tested for compatibility with WP 5.4. 
* Revised Java detection.

== About ==

**Other modules**

Secure Image was specially designed to display encrypted images on web pages for all computers. A most versatile yet sophisticated [image protection](http://www.artistscope.com/secure_image_protection.asp) solution that anyone can use.

* The [Secure Image converter](http://www.artistscope.com/secure_image_protection.asp) is available as Windows desktop software.
...
While Secure Image provides the most sophisticated image encryption with domain lock, it cannot provide [protection from PrintScreen or screen capture](http://www.artistscope.com/copysafe_web_protection.asp). However other solutions are available from ArtistScope that do provide such protection from all copy including capture, such as [CopySafe Web Protection]( http://www.artistscope.com/copysafe_web_protection.asp) which is specially designed for images, [CopySafe PDF Protection](http://www.artistscope.com/copysafe_pdf_protection.asp) which is specially designed for PDF documents and the [ArtistScope Site Protection System (ASPS)](http://www.artistscope.com/asps_web_site_protection.asp) uses a secure web browser that is properly designed to protect web media rather than expose it. Each of these solutions have WordPress plugins or widgets available for easy integration into your WordPress project.
